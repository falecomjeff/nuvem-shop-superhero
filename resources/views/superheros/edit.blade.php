...
@section('content')
    ...
    @if(count($superhero->superheroImages))
        <div class="row justify-content-md-center">
            <div class="col col-lg-8">
                <p>
                    <h4>Actual superhero images</h4>
                    <hr>
                </p>
                @foreach($superhero->superheroImages as $superheroImage)
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dynamic_field">
                            <tr>
                                <td>
                                    <a href="{{ url('/') }}/images/{{ $superheroImage->name }}" target="_new">{{ $superheroImage->name }}</a>
                                </td>
                                <td>
                                    <!-- <button type="button" name="delete" id="delete" class="btn btn-danger">Remove image</button> -->
                                    {!! Form::open(array('url' => 'superheroImage/' . $superheroImage->id, 'class' => 'pull-right')) !!}
